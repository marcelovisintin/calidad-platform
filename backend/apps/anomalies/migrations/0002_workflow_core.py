    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("recommended_stage", models.CharField(blank=True, choices=[("registration", "Registro"), ("containment", "Contencion"), ("initial_verification", "Verificacion inicial"), ("classification", "Clasificacion"), ("cause_analysis", "Analisis de causa"), ("proposals", "Propuestas"), ("action_plan", "Plan de accion"), ("execution_follow_up", "Ejecucion y seguimiento"), ("results", "Resultados"), ("effectiveness_verification", "Verificacion de eficacia"), ("closure", "Cierre"), ("standardization_learning", "Estandarizacion y aprendizaje")], max_length=40)),
