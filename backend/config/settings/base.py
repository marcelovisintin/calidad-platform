...
EMAIL_DUE_REMINDER_DAYS = env_int("EMAIL_DUE_REMINDER_DAYS", default=2)
EMAIL_DUE_DIGEST_HOUR = env_int("EMAIL_DUE_DIGEST_HOUR", default=7)
...
EVIDENCE_FILE_MAX_SIZE = env_int("EVIDENCE_FILE_MAX_SIZE", default=20 * 1024 * 1024)
USER_PHOTO_MAX_SIZE = env_int("USER_PHOTO_MAX_SIZE", default=5 * 1024 * 1024)
