...
import { EmailTemplateManagementPage } from "../modules/admin/pages/EmailTemplateManagementPage";
...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: "management/email-templates", element: <EmailTemplateManagementPage /> },
    ],
  },
  {
    path: "*",
