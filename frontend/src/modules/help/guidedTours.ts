...
const TOURS: Record<string, GuidedTourDefinition> = {
  ...
  anomalyTracking: {
    ...
    steps: [
      ...
      { selector: ".anomaly-classification-control", title: "Revisión de hallazgos", content: "Selecciona Inválida, No conformidad, Observación u Oportunidad de mejora. Si eliges No conformidad, define responsable, fecha límite y un comentario opcional para crear un tratamiento nuevo." },
  ...
  observations: {
    ...
    steps: [
      ...
      { selector: '[data-tour="observation-general"]', title: "Datos generales", content: "El responsable proviene de Revisión de hallazgos. Consulta la fecha límite de ejecución y completa la causa asignada antes de continuar." },
      { selector: '[data-tour="observation-cause"]', title: "Causa asignada", content: "El responsable debe explicar la causa de la observación. Es obligatoria y queda en solo lectura después de confirmar la carga." },
