...
const TOURS: Record<string, GuidedTourDefinition> = {
  ...
  newAnomaly: {
    ...
    steps: [
      { selector: ".form-hero", title: "Nueva anomalía", content: "Aquí comienza el registro. Puedes completar la carga sin límite de tiempo mientras la sesión esté abierta; el código consecutivo se asigna al confirmar." },
      ...
      { selector: '[data-tour="anomaly-area"]', title: "Elaborado por", content: "Selecciona el área o proceso donde se origina el registro. Puedes escribir las primeras letras para filtrar la lista." },
      { selector: '[data-tour="anomaly-imputed-area"]', title: "Asignado a", content: "Selecciona el área o proceso relacionado con la anomalía. Puedes escribir las primeras letras para filtrar la lista." },
      { selector: '[data-tour="anomaly-type"]', title: "Tipo de Desvío", content: "Falla, defecto o evento detectado. Puedes escribir las primeras letras para filtrar la lista." },
  ...
  indicatorDashboard: {
    ...
    steps: [
      ...
      { selector: '[data-tour="indicator-grouping"]', activateSelector: '.tabbed-filter-tab[data-filter-id="grouping"]', title: "Agrupación de Pareto", content: "Solo en Repeticiones y Pareto puedes agrupar por proceso y tipo, proceso, tipo, origen, clasificación u orden afectada. Escribe las primeras letras para filtrar las opciones. Cambia la agrupación del análisis, no los registros originales." },
  ...
  users: {
    ...
    steps: [
      ...
      { selector: '[data-tour="user-access-level"]', title: "Nivel de acceso", content: "Selecciona el nivel correspondiente a las responsabilidades que tendrá la persona. Puedes escribir las primeras letras para filtrar las opciones." },
